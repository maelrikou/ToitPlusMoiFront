...
const routes: Routes = [
  ...
  { path: 'ensembleBien', canActivate: [AuthguarproprioService], component: EnsembleBienComponent },
  { path: 'messagerie', canActivate: [AuthgardService], component: MessagerieComponent}
];
